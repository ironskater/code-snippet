...
public class PersistenceConfig
{
    ...
    public DataSource dataSource() {
        ...
        HikariDataSource source = dataSourceBuilder
                                        .driverClassName(this.env.getProperty("jdbc.driver"))
                                        .url(this.env.getProperty("jdbc.url"))
                                        .username(this.env.getProperty("jdbc.user"))
                                        .password(this.env.getProperty("jdbc.password"))
                                        .build();
