package codesnippet.spring.thymeleaf.model;
...
import codesnippet.spring.thymeleaf.validation.FieldMatch;
import codesnippet.spring.thymeleaf.validation.ValidEmail;
...
public class UserRegisterInfo implements Serializable {
    ...
    public String toString() {
        return "UserRegisterInfo [userName=" + userName + ", password=" + password + ", matchingPassword="
